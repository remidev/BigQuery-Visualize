      ...
      return (
        <div>
          ...
          <div>
            ...
            <LineChartWithReference chart={this.data} />
          </div>
          <hr />
          <div>
            {" "}
            ...
            <small>
              Please Note: BiaxialLineChart Only Works With 2 Int Values
            </small>
            <BiaxialLineChart chart={this.data} />
          </div>
          <hr /> */}
        </div>
      );
      ...
      return (
        <div>
          <div>
            ...
            <OverlayAreaChart chart={this.data} />
          </div>
          <div>
            {" "}
            <h1 className="text-center">Percent Chart</h1>{" "}
            <PercentChart chart={this.data} />
          </div>
        </div>
      );
    },
      ...
      return (
        <div>
          <div>
            ...
            <BarChartN chart={this.data} />
          </div>
          <div>
            {" "}
            <h1 className="text-center">Stacked Bar Chart</h1>{" "}
            <BarChartStacked chart={this.data} />
          </div>
          <div>
            {" "}
            <h1 className="text-center">Negative Bar Chart</h1>
            <CanNegativeBarChart chart={this.data} />
          </div>
          <div>
            {" "}
            <h1 className="text-center">Biaxial Chart</h1>{" "}
            <BiaxialBarChart chart={this.data} />
          </div>
        </div>
      );
    },
    ...
    chart() {
      return (
        <div>
          ...
          <ComposedDataChart chart={this.data} />
        </div>
      );
    },
    type: "DataChart",
